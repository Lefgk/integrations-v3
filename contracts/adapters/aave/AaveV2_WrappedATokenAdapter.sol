    ...
    IAaveV2_WrappedATokenAdapter
{
    ...
    function depositDiffUnderlying(
        uint256 leftoverAssets
    )
        external
        override
    ...
    function withdrawDiff(
        ...
        returns (uint256 tokensToEnable, uint256 tokensToDisable)
    {
        (tokensToEnable, tokensToDisable) = _withdrawDiff(
            false,
            leftoverShares
        ); // U:[AAVE2W-8]
    }
    ...
    function withdrawDiffUnderlying(
        uint256 leftoverShares
    )
        external
        override
    ...
    function _withdraw(
        ...
        (tokensToEnable, tokensToDisable) = (
            toUnderlying ? tokenMask : aTokenMask,
            0
        ); // U:[AAVE2W-7,9]
    }
    ...
    function _withdrawDiff(
        ...
        (tokensToEnable, tokensToDisable) = (
            toUnderlying ? tokenMask : aTokenMask,
            leftoverAmount <= 1 ? waTokenMask : 0
        ); // U:[AAVE2W-8,10]
    }
